      ...
      <div class="bg-white rounded-2xl shadow-xl p-8 border border-pink-100">
        ...
        <form @submit.prevent="handleProfileUpdate" class="space-y-6">
          ...
          <div class="border-t border-gray-200 pt-6 mt-6">
            ...
            <!-- 目標案件数 -->
            <div class="mb-4">
              <label class="block text-sm font-medium text-gray-700 font-noto mb-2">
                目標案件数
              </label>
              <div class="relative">
                <input 
            ...
            <button
              ...
              class="w-full flex justify-center items-center px-6 py-3 font-semibold rounded-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed font-poppins bg-gradient-to-r from-indigo-500 to-purple-600 text-white hover:from-indigo-600 hover:to-purple-700"
