...
// 優先度フレーム色
const getPriorityFrameColor = (priority) => {
  switch (priority) {
    case 'high': return 'border-gradient-red-pink'
    case 'medium': return 'border-gradient-amber-yellow'
    case 'low': return 'border-gradient-green-emerald'
    default: return 'border-gradient-gray'
  }
}
              ...
              <div class="flex items-start space-x-4">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex flex-wrap gap-3 text-sm">
                    <span class="berry-badge-frame" :class="getPriorityFrameColor(todo.todo_priority)">
                      優先度: {{ todo.todo_priority }}
                    </span>
                    <span class="berry-badge-frame border-gradient-blue-indigo">
                      重要度: {{ '⭐'.repeat(todo.todo_importance) }} {{ todo.todo_importance }}
                    </span>
                    <span v-if="todo.todo_due_date" class="berry-badge-frame border-gradient-purple-pink">
                      期限: {{ todo.todo_due_date }}
                    </span>
                    <span v-if="todo.linked_project_id" class="berry-badge-frame border-gradient-blue-cyan flex items-center gap-1">
                      <FolderIcon :size="14" color="#6b7280" />
                      案件: {{ getProjectName(todo.linked_project_id) }}
                    </span>
                    <span v-if="todo.linked_invoice_id" class="berry-badge-frame border-gradient-green-emerald flex items-center gap-1">
                      <MoneyIcon :size="14" color="#6b7280" />
...
.border-gradient-red-pink::before {
  content: '';
  position: absolute;
  top: 0;
  left: 0;
  ...
  border-radius: 9999px;
  padding: 2px;
  background: linear-gradient(to right, #fca5a5, #f9a8d4);
...
.border-gradient-amber-yellow::before {
  content: '';
  position: absolute;
  top: 0;
  left: 0;
...
.border-gradient-green-emerald::before {
  content: '';
  position: absolute;
  top: 0;
  left: 0;
...
.border-gradient-blue-indigo::before {
  content: '';
  position: absolute;
  top: 0;
  left: 0;
...
.border-gradient-blue-cyan::before {
  content: '';
  position: absolute;
  top: 0;
  left: 0;
